...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            {
                var userInDb = _userContext.Users.FirstOrDefault(x => x.Email == model.Username || x.Login == model.Username);
                ...
                if (userInDb != null && model.Password == userInDb.Senha)
                {
                    ...
                    var claims = new[]
                    {
                        ...
                        new Claim("UserName", userInDb.Nome),
                        new Claim("UserEmail", userInDb.Email)
                    };

                    // issue authentication cookie with subject ID and username
                    await HttpContext.SignInAsync(userInDb.ID.ToString(), userInDb.Email, props, claims);
