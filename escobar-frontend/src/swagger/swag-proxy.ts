...
export class ApiServiceProxy {
     ...
     * @return Success
     */
    comandosGet(id: string): Observable<void> {
    ...
    protected processComandosGet(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    userComandosGet(id: string): Observable<void> {
    ...
    protected processUserComandosGet(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
